...
def main():
    ...
    feature_list_file = FEATURE_LIST_SELECTION_FILE
    ...
    elif feature_list_file is not None and os.path.exists(feature_list_file):
        selected_features_list = []
        csv_readed = pd.read_csv(feature_list_file)
        selected_features_list = [
            [f.strip() for f in features_str.strip('[]').split(',')]
            for features_str in csv_readed['features']
        ]
